...
namespace Gilanggustina\ModuleLabRadiology\Facades;
...
*/
class ModuleLabRadiology extends \Illuminate\Support\Facades\Facade
{
    /**
    ...
    {
        return \Gilanggustina\ModuleLabRadiology\Contracts\ModuleLabRadiology::class;
    }
}